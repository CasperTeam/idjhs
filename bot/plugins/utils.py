...
@Client.on_message(filters.incoming & filters.command(['log']) & filters.user(SUDO_USERS), group=2)
...
@Client.on_message(filters.incoming & filters.command(['restart']) & filters.user(SUDO_USERS), group=2)
